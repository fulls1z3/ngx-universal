# Contributing to ngx-universal

We would love for you to contribute to **`ngx-universal`** and help make it even better than it is today! As a contributor,
...
Help us keep **`ngx-universal`** open and inclusive. Please read and follow our [Code of Conduct][coc].
...
You can file new issues by filling out our [new issue form](https://github.com/fulls1z3/ngx-universal/issues/new).

### <a name="submit-pr"></a> Submitting a Pull Request (PR)
Before you submit your Pull Request (PR) consider the following guidelines:

* Search [GitHub](https://github.com/fulls1z3/ngx-universal/pulls) for an open or closed PR that relates to your submission.
...
* Push your branch to GitHub:
    ...
    ```
* In GitHub, send a pull request to `state-transfer:master`.
...
Samples: (even more [samples](https://github.com/fulls1z3/ngx-universal/commits/master))
```
...
[coc]: https://github.com/fulls1z3/ngx-universal/blob/master/CODE_OF_CONDUCT.md
[github]: https://github.com/fulls1z3/ngx-universal
